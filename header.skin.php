<div class="header">
  ...
  <div class="header_section_items">
    <div class="header_section_item">
      <a href="#">
        <img src="<?php echo $cfg['doc_root']; ?>/file/server.png" alt="#asdasd" title="Server">
      </a>
    </div>
    <div class="header_section_item">
      <a href="#">
        <img src="<?php echo $cfg['doc_root']; ?>/file/frontend.png" alt="frontend" title="html, css, js">
      </a>
    </div>
  </div>
</div>